...
pub const KNIGHT_PROMOTION_CAPTURE: u16 = 0xC;
pub const BISHOP_PROMOTION_CAPTURE: u16 = 0xD;
pub const ROOK_PROMOTION_CAPTURE: u16 = 0xE;
pub const QUEEN_PROMOTION_CAPTURE: u16 = 0xF;
