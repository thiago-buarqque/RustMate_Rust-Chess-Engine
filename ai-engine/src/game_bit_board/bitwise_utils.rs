pub fn to_bitboard_position(position: u64) -> u64 {
    1 << position
}
...
pub fn upper_bits(b: u64, square: u64) -> u64 {
    (!b) << square
}

pub fn lower_bits(b: u64, square: u64) -> u64 {
    (1 << square) - 1
}

#[cfg(test)]
mod tests {
    use crate::game_bit_board::{board::Board, enums::{Color, PieceType}, positions::{H2, H3, H8}};
